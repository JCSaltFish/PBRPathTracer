...
void InitializePathTracer()
{
    ...
    pathTracer.LoadMesh("cube.obj.object", glm::translate(glm::rotate(glm::scale(glm::mat4(1.0f), glm::vec3(1.0f)), 45.0f, glm::vec3(1.0, 0.0, 0.0)), glm::vec3(0.0f, -2.0f, 0.0f)), glm::vec3(1.0f, 1.0f, 0.0f), 1.0f, 0.5f);
